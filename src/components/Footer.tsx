        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Diagnóstico completo em 90 minutos, cuidado humano para toda a família.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-white hover:text-medici-coral transition-colors">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-2">
              BR-020, Km 12 - Caucaia, CE
            </p>
            <p className="text-gray-300 mb-4">
              contato@mediciclinica.com.br<br />
              +55 85 3333-4444
            </p>
            <div className="bg-white/10 rounded-lg p-4">
              <p className="text-sm text-gray-300">
                Este estudo de viabilidade foi preparado com base em dados de mercado e projeções 
                financeiras de maio/2023 a abril/2024.
              </p>
            </div>
          </div>
        </div>
